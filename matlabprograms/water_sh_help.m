function water = water_sh(pressure, name2, value2, units) 
% -------------------------------------------------------------------------
% water_sh.m
% -------------------------------------------------------------------------
% ENGR3322 Fundamentals of Thermodynamics
% A function that uses two independent properties of superheated water 
% vapor (steam) and defines as the output a structure with
...
% -------------------------------------------------------------------------
% Syntax: water = water_sh(pressure, name2, value2, units) 
...
%         enthalpy, entropy, quality and message). All specific properties 
%         defined per unit mass. Message is 1 if state is in superheated
%         region, 0 if not. Though undefined (NaN), quality is included
...
%--------------------------------------------------------------------------
% Example
% water = water_sh(40, 'Temperature', 500, 1)
% This example corresponds to superheated steam (water) at a pressure of 
% 40 bar, and with a temperature of 500 degrees C.
%--------------------------------------------------------------------------
% Simon Ruiz, Undergraduate student, Mechanical Engineering 
% Dr.Priya Goeser, Associate Professor
% Original: March 12th, 2013
% Modified: March 6th 2014

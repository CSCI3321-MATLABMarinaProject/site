function ammonia = ammonia_sc(temperature, name2, value2, units)
% -------------------------------------------------------------------------
% ammonia_sc.m
% -------------------------------------------------------------------------
% ENGR3322 Fundamentals of Thermodynamics
% A function that uses two properties of subcooled ammonia (as within the
...
% -------------------------------------------------------------------------
% Syntax: ammonia = ammonia_sc(temperature, name2, value2, units)
...
%--------------------------------------------------------------------------
% Example
% ammonia = ammonia_sc('Temperature', 25, 'Pressure', 50, 1)
% This example corresponds to saturated water at 25 degrees C, and with a
% specific volume of 50 m^3/kg.
%--------------------------------------------------------------------------

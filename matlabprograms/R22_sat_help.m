function R22 = R22_sat(name1, value1, name2, value2, units) 
% -------------------------------------------------------------------------
% R22_sat.m
% -------------------------------------------------------------------------
% ENGR3322 Fundamentals of Thermodynamics
% A function that uses two independent properties of saturated R22 
...
% -------------------------------------------------------------------------
% Syntax: R22 = R22_sat(name1, value1, name2, value2, units) 
...
%--------------------------------------------------------------------------
% Example
% R22 = R22_sat('Temperature', 0, 'Specific Volume', 0.01, 1)
% This example corresponds to saturated Refrigerant 22 at 0 degrees C, and
% with a specific volume of 0.01 m^3/kg
%--------------------------------------------------------------------------

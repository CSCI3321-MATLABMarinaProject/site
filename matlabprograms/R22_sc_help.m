function R22 = R22_sc(temperature, name2, value2, units)
% -------------------------------------------------------------------------
% R22_sc.m
% -------------------------------------------------------------------------
% ENGR3322 Fundamentals of Thermodynamics
% A function that uses two properties of subcooled refrigerant 22 (as
...
% -------------------------------------------------------------------------
% Syntax: R22 = R22_sc(temperature, name2, value2, units)
% Inputs: temperature = the temperature of the refrigerant 22

...
<body>
  <div id="main">
	...
	<script>
	  (function() {
	    var cx = '017270740075728413624:ij7eqggzjpw';
	...
	<gcse:search></gcse:search>
        ...
        <div class="sidebar">
          ...
          <h4>Timeline</h4>
          <h5>April 2014</h5>
          <p>Most modules used in typical introductory programming courses have been completed. 
		  Click below for a detailed timeline. 
		 <br /><a href="timeline.html">Read more</a>
		  </p>
        </div>
      </div>
      <div class="content">

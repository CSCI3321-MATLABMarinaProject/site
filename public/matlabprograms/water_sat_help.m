function water = water_sat(name1, value1, name2, value2, units) 
% -------------------------------------------------------------------------
% water_sat.m
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
% Syntax: water = water_sat(name1, value1, name2, value2, units) 
...
%         defined per unit mass. Message is 1 if state is in vapor dome,
%         0 if state is not in vapor dome. 
% -------------------------------------------------------------------------
